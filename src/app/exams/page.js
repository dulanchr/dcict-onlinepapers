          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className={`transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="flex gap-2 items-start justify-center text-black">
                <p className="text-base md:text-lg lg:text-[22px] uppercase font-light tracking-normal">Examinations</p>
                <p className="text-base md:text-lg lg:text-[22px] uppercase tracking-normal" style={{ fontFamily: 'Rashmi, sans-serif' }}>පුහුණුවීම් සහ විභාග</p>
              </div>
            </div>
          </div>
          <div className="mt-8">
